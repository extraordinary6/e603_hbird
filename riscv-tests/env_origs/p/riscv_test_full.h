...
#ifndef _RISCV_TEST_FULL_H__
#define _RISCV_TEST_FULL_H__
...
#define ICACHE_INIT csrw CSR_MCACHECTL , 0x1
#endif

#ifndef N600_CFG_HAS_ICACHE
...
\
        ...
        sw t1, 0(t0);\
#endif \
        csrr t2,CSR_MISC_CTL;       \
        andi t2,t2,0x200;\
        bnez t2, ignore_nmi_judge;\
\
        csrr t2, mcause; \
        andi t2, t2, 0x7ff;\
        xori t2,t2,0x1;\
        beqz t2, nmi_interrupt;\
ignore_nmi_judge:\
        INITIAL_X ;               \
        /* reset vector */                                              \
        j  reset_vector;                                                \
...
/*upper code is used for compatibility of old ccts, there is no use for new ccts*/\
  ...
  handle_exception:                                                       \
        ...
        and t1, t2, t1;                                                 \
        li t2, CAUSE_NMI;                                        \
        beq t1, t2,trap_vector_close_nmi_irq;                                       \
